...
import type { Configuration } from '@datadog/browser-core/cjs/domain/configuration';
import type { StackTrace } from '@datadog/browser-core/cjs/domain/tracekit';
import { Observable } from '@datadog/browser-core/cjs/tools/observable';
import type { TelemetryEvent } from '@datadog/browser-core/cjs/domain/telemetry/telemetryEvent.types';
import type { RawTelemetryConfiguration } from '@datadog/browser-core/cjs/domain/telemetry/rawTelemetryEvent.types';
