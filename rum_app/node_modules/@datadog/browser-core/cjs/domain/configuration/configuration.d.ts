import type { CookieOptions } from '@datadog/browser-core/cjs/browser/cookie';
import type { RawTelemetryConfiguration } from '@datadog/browser-core/cjs/domain/telemetry';
import type { TransportConfiguration } from '@datadog/browser-core/cjs/domain/configuration/transportConfiguration';
