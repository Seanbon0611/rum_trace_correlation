...
import type { RumFetchResolveContext, RumFetchStartContext, RumXhrCompleteContext, RumXhrStartContext } from '@datadog/browser-rum-core/cjs/domain/requestCollection';
import type { RumSessionManager } from '@datadog/browser-rum-core/cjs/domain/rumSessionManager';
import type { TracingOption } from '@datadog/browser-rum-core/cjs/domain/tracing/tracer.types';
