...
import type { RumPerformanceEntry } from '@datadog/browser-rum-core/cjs/browser/performanceCollection';
import type { RumEventDomainContext } from '@datadog/browser-rum-core/cjs/domainContext.types';
import type { RawRumEvent } from '@datadog/browser-rum-core/cjs/rawRumEvent.types';
import type { RumEvent } from '@datadog/browser-rum-core/cjs/rumEvent.types';
import type { CommonContext } from '@datadog/browser-rum-core/cjs/domain/contexts/commonContext';
import type { RequestCompleteEvent, RequestStartEvent } from '@datadog/browser-rum-core/cjs/domain/requestCollection';
import type { AutoAction } from '@datadog/browser-rum-core/cjs/domain/rumEventsCollection/action/actionCollection';
import type { ViewEvent, ViewCreatedEvent, ViewEndedEvent } from '@datadog/browser-rum-core/cjs/domain/rumEventsCollection/view/trackViews';
